        ...
        <div className={styles.donationForm}>
            <div className="flex flex-wrap justify-between mb-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                   ...
                   {showCustomAmount  && <input onChange={(e) => setAmount(e.target.value)} type="text" id="lname" name="lastname" placeholder="Your last name.."></input>}

                    <input type="submit" value="Submit" {...register("example")} ></input>
                </form>
            )}
            </div>
